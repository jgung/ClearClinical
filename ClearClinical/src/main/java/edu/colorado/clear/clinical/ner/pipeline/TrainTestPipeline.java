...
public class TrainTestPipeline
{
	...
	public static String semeval_train = resourceDirPath + "semeval-2014-task-7/data/trainsubset";
	public static String semeval_devel = resourceDirPath + "semeval-2014-task-7/data/develsubset";
